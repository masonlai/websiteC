...
data = connect.select_func2("""SELECT commentId from contact_us where staffID = '"""+user+"""'""")

try:
    print("""<div style="top:20px;left:1100px;position:absolute;">
     you have """+str(len(data))+""" comment that you need to handle</div>""")
    ...
    print("""<div style="top:20px;left:1100px;position:absolute;">
     you have no comment that you need to handle</div>""")
    print("""<div style="top:60px;left:1100px;position:absolute;">
    <input type ="button" onclick="history.back()" value="Back">
    </input></div>""")
